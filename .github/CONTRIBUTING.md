# Contributing to langchain_sql_test

Hi there! Thank you for even being interested in contributing to langchain_sql_test.
...
langchain_sql_test follows the [semver](https://semver.org/) versioning standard.
